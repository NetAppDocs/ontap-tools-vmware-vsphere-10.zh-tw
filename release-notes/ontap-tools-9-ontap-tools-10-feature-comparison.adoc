...
| ONTAP 發行資格 | ONTAP 9.9.1 升級至ONTAP 9.16.1 | ONTAP 9 。 12.1 至 ONTAP 9 。 14.1 | ONTAP工具 10.2 的ONTAP 9.12.1 升級到ONTAP 9.15.1。適用於ONTAP工具 10.3 的ONTAP 9.14.1、9.15.1、9.16.0 和 9.16.1。適用於ONTAP工具 10.4 的ONTAP 9.14.1、9.15.1、9.16.0 和 9.16.1。使用ASA r2 系統時， ONTAP工具 10.4 需要ONTAP 9.16.1P3 及更高版本。 
