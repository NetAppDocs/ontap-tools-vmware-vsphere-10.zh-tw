...
[role="lead"]
適用於 VMware vSphere 的 ONTAP 工具是多租戶系統、可管理多個 vCenter Server 執行個體。ONTAP 工具管理員可透過託管的 vCenter Server 執行個體和已建立的儲存後端、為 VMware vSphere 管理員提供更多的 ONTAP 工具控制權。
