...
. 在*自訂範本*視窗中，填寫必填欄位並選擇*下一步*。image:../media/sys-conf.png["自訂模板"]
+
...
. 使用 vCenter Server 8.0.3 版本時，在 *自訂硬體* 視窗中，啟用 *CPU 熱添加* 和 *記憶體熱插拔* 選項以允許 HA 功能。image:../media/customize-hw105.png["客製化硬體"] image:../media/customize-hw.png["客製化硬體"]
