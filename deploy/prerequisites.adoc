...
您可以將 ONTAP tools for VMware vSphere 與 VMware vCenter Server Virtual Appliance（vCSA）搭配使用。您應該將 ONTAP tools for VMware vSphere 部署在包含 ESXi 主機的受支援 vSphere 環境中。
